...
import { authenticateUser, issueSession, SESSION_COOKIE, SESSION_MAX_AGE_SECONDS } from "../../../lib/auth";
...
export async function POST(request: Request) {
  ...
  const ip = requestIp(request); const normalized = normaliseIdentifier(identifier);
