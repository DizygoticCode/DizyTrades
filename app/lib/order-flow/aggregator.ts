...
export class FlowAggregator {
  ...
  replaceCompact(changes:readonly CompactLiquidityChange[],capturedPriceStep:number,contractSize:number){this.heatmap=[];this.lastLevels.clear();this.captureStarted=null;this.captureEnded=null;this.ingestCompact(changes,capturedPriceStep,contractSize)}
