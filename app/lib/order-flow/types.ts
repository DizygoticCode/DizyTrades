...
export type HeatmapCell = { timeMs: number; price: number; bidNotional: number; askNotional: number; bidQuantity?:number; askQuantity?:number; mid: number; spread: number };
