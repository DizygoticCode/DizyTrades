...
function marginSettlementAudit(value:unknown,field:string,expectedMode?:unknown,expectedMargin?:unknown):ManualFill["marginSettlement"]{
 if(value==null)return undefined;
...
function fill(value: unknown, index: number): ManualFill {
  ...
  return Object.freeze({
    ...
    marginSettlement: marginSettlementAudit(input.marginSettlement, "manualPaper.fill.marginSettlement", input.marginMode, input.marginUsed),
    riskPriceSource:
...
function fundingPayment(value:unknown,index:number):ManualFundingPayment{
