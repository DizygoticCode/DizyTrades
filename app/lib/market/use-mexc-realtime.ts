...
type Options = { enabled: boolean; symbol: string; timeframe: CandleTimeframe; contractSize?: number; onKline: (candle: Candle) => void; onDeal: (deal: MexcDeal) => void; onStatus: (status: RealtimeStatus) => void; onClockOffset: (offsetMs: number) => void; onResync: () => void };
