...
const reasons = new Set<ExecutionBlockCode | ExecutionRejectionCode | ExecutionRiskCode>([
  ...
  "EXECUTION_OWNERSHIP_BINDING_MISSING", "EXECUTION_OWNERSHIP_BINDING_MISMATCH",
  "EXECUTION_OWNERSHIP_BINDING_INVALID", "EXECUTION_OWNERSHIP_UNKNOWN",
  "EXECUTION_OWNERSHIP_INACTIVE", "EXECUTION_OWNERSHIP_REVOKED",
  "EXECUTION_OWNERSHIP_PROOF_STALE", "EXECUTION_OWNERSHIP_UNAVAILABLE",
