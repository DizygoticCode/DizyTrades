...
export class SqliteExecutionRolloutStore implements ExecutionRolloutStore {
  private database:DatabaseSync|null=null; private file:{dev:number;ino:number}|null=null;
